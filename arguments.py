...
def get_args():
    ...
    parser.add_argument('--train_crop', action='store_true', default=False, help='train cropped objects')
    parser.add_argument('--type_crop', default="padding", help='pad object to the same size / resize')
    parser.add_argument('--train_seg', action='store_true', default=False, help='train segmented images')
